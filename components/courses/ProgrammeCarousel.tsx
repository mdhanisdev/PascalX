      ...
      <div className="programme-carousel-window">
        <div className="programme-carousel-track" style={{ transform: `translateX(-${activeIndex * 100}%)` }}>
          {courses.map((course, index) => (
            <Link className="programme-slide" href={`/programmes/${course.slug}`} scroll transitionTypes={["nav-forward"]} key={course.slug} aria-hidden={activeIndex !== index} tabIndex={activeIndex === index ? 0 : -1}>
